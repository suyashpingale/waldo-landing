...
const compatibilityItems = [
  { label: "Apple Watch", src: "/assets/health-apple-watch.webp", imageClassName: "max-h-8 max-w-[58px]" },
  { label: "WHOOP", src: "/assets/health-whoop.webp", imageClassName: "max-h-9 max-w-[46px]" },
